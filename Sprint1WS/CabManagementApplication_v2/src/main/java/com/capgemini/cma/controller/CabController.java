...
public class CabController {
	...
	@PostMapping("")
	public ResponseEntity<?> createNewCab(@Valid @RequestBody Cab cab, BindingResult result) {
	...
	@GetMapping("/{cabId}")
	ResponseEntity<?> getCabById(@PathVariable String cabId) {
		
		Cab cab = cabService.findCabByCabIdentifier(cabId);
...
//	}
	...
	@DeleteMapping("/cabId")
	public ResponseEntity<?> deleteCab(@PathVariable String cabId) {
		
		cabService.deleteCabByCabIdentifier(cabId);
		
		return new ResponseEntity<String>("Cab with Id : " + cabId.toUpperCase() + " deleted successfully!", HttpStatus.OK);
	}
}
